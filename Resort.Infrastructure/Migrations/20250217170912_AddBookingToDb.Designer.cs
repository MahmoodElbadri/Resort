...
namespace Resort.Infrastructure.Migrations
{
    ...
    [Migration("20250217170912_AddBookingToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resort.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resort.Domain.Entities.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Capacity = 0,
                            CreatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4817),
                            ...
                            Price = 200.0,
                            Sqft = 300,
                            UpdatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4942)
                        },
                        new
                        {
                            Id = 2,
                            Capacity = 0,
                            CreatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4962),
                            ...
                            Price = 150.0,
                            Sqft = 200,
                            UpdatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4969)
                        },
                        new
                        {
                            Id = 3,
                            Capacity = 0,
                            CreatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4981),
                            ...
                            Price = 600.0,
                            Sqft = 100,
                            UpdatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4988)
                        },
                        new
                        {
                            Id = 4,
                            Capacity = 0,
                            CreatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(4999),
                            ...
                            Price = 700.0,
                            Sqft = 120,
                            UpdatedDate = new DateTime(2025, 2, 17, 19, 9, 8, 411, DateTimeKind.Local).AddTicks(5005)
                        });
                });
            ...
            modelBuilder.Entity("Resort.Domain.Entities.Booking", b =>
                {
                    b.HasOne("Resort.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
