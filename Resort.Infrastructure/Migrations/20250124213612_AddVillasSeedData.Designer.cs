...
namespace Resort.Infrastructure.Migrations
{
    ...
    [Migration("20250124213612_AddVillasSeedData")]
    partial class AddVillasSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Resort.Domain.Entities.Villa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1052),
                            ...
                            Price = 200.0,
                            SqrFeet = 300,
                            UpdatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1219)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1224),
                            ...
                            Price = 150.0,
                            SqrFeet = 200,
                            UpdatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1226)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1231),
                            ...
                            Price = 600.0,
                            SqrFeet = 100,
                            UpdatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1229)
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1236),
                            ...
                            Price = 700.0,
                            SqrFeet = 120,
                            UpdatedDate = new DateTime(2025, 1, 24, 23, 36, 10, 838, DateTimeKind.Local).AddTicks(1234)
                        });
                });
